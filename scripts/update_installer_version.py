...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Disthorzion Demo Installer\n"
      else:
        line="OutputBaseFilename=Disthorzion Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Disthorzion Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Disthorzion installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Disthorzion Demo installer\n"
     else:
       line="SetupWindowTitle=Disthorzion installer\n"
